...
class UpdateTeamRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'email' => ['required', 'unique:users,email,' . request()->route('team')->user_id, 'email', 'max:' . Builder::$defaultStringLength],
            // 'username' => ['required', 'alpha_num', 'starts_with:a,b,c,d,e,f,g,h,i,j,k,l,m,n,o,p,q,r,s,t,u,v,w,x,y,z', 'min:6', 'max:30', 'unique:users,username,' . request()->route('team')->user_id],

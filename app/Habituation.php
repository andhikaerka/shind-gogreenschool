...
class Habituation extends Model implements HasMedia
{
    use Auditable;
    use InteractsWithMedia;
    use Activable;

    public $table = 'habituations';
    ...
    const MAX_LENGTH_OF_PROGRAM = 50;
    const LIST_OF_CATEGORY = ['Rutin', 'Spontan', 'Keteladanan'];
    const MAX_LENGTH_OF_TUTOR = 100;
    const MAX_LENGTH_OF_TIME = 50;

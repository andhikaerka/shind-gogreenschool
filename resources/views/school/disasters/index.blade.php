...
@section('title')
    {{ trans('global.list') }} {{ trans('crud.disaster.title_singular') }} - {{ trans('panel.site_title') }}
@endsection
            ...
            <div style="margin-bottom: 10px;" class="row">
                <div class="col-lg-12">
                    <a class="btn btn-success"
                       href="{{ route("school.disasters.create", ['school_slug' => $school_slug, 'year' => request()->input('year')]) }}">
            ...
            <form action="" method="get" class="mb-3">
                <div class="row form-row">
                    ...
                    <div class="col mr-sm-2">
                        <div class="input-group">
                            <div class="input-group-prepend">
                                <span class="input-group-text bg-transparent border-0">Kondisi {{ trans('crud.disaster.title') }}&nbsp;:</span>
                            </div>
                            <div class="input-group-append">
    ...
    <script>
        $(function () {
            ...
            let deleteButton = {
                ...
                url: "{{ route('school.disasters.massDestroy', ['school_slug' => $school_slug]) }}",
            ...
            let dtOverrideGlobals = {
                ...
                aaSorting: [],
                ajax: {
                    url: "{{ route('school.disasters.index', ['school_slug' => $school_slug]) }}",
                    data: {

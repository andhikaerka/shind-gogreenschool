    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="form-group">
                <div class="form-group">
                    <a class="btn btn-default" href="{{ route('school.studies.index', ['school_slug' => $school_slug]) }}">
    ...
    {{--<div class="card">
        ...
        <div class="tab-content">
            <div class="tab-pane" role="tabpanel" id="study_work_programs">
                @includeIf('school.studies.relationships.studyWorkPrograms', ['workPrograms' => $study->studyWorkPrograms])
            </div>
        </div>
    </div>--}}

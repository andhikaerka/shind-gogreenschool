...
@section('title')
    {{ trans('global.list') }} {{ trans('crud.environmentalIssue.title_singular') }} - {{ trans('panel.site_title') }}
@endsection
...
@section('content')
            ...
            <div style="margin-bottom: 10px;" class="row">
                <div class="col-lg-12">
                    <a class="btn btn-success"
                       href="{{ route("school.environmental-issues.create", ['school_slug' => $school_slug, 'year' => request()->input('year')]) }}">
                        {{ trans('global.add') }} {{ trans('crud.environmentalIssue.title_singular') }}
                    </a>
                </div>
            </div>
        @endcan
    ...
    <div class="card">
        <div class="card-header">
            {{ trans('global.list') }} {{ trans('crud.environmentalIssue.title_singular') }}
        </div>
        ...
        <div class="card-body">
            <form action="" method="get" class="mb-3">
                <div class="row form-row">
                    ...
                    <div class="col mr-sm-2">
                        <div class="input-group">
                            <div class="input-group-prepend">
                                <span class="input-group-text bg-transparent border-0">Kondisi {{ trans('crud.environmentalIssue.title') }}&nbsp;:</span>
                            </div>
                            <div class="input-group-append">
            ...
            <table class=" table table-bordered table-striped table-hover ajaxTable datatable datatable-Cadre">
                ...
                <tr>
                    ...
                    <th>
                        {{ trans('crud.environmentalIssue.fields.potency') }}
                    </th>
                    <th>
                        {{ trans('crud.environmentalIssue.fields.date') }}
                    </th>
                    <th>
                        {{ trans('crud.environmentalIssue.fields.category') }}
                    </th>
                    <th>
                        {{ trans('crud.environmentalIssue.fields.problem') }}
                    </th>
                    <th>
                        {{ trans('crud.environmentalIssue.fields.anticipation') }}
                    </th>
                    <th>
                        {{ trans('crud.environmentalIssue.fields.compiler') }}
                    </th>
                    <th>
                        {{ trans('crud.environmentalIssue.fields.document') }}
                    </th>
                    <th>
                        {{ trans('global.action') }}
                    </th>
    ...
    <script>
        $(function () {
            ...
            let deleteButton = {
                ...
                url: "{{ route('school.environmental-issues.massDestroy', ['school_slug' => $school_slug]) }}",
            ...
            let dtOverrideGlobals = {
                ...
                aaSorting: [],
                ajax: {
                    url: "{{ route('school.environmental-issues.index', ['school_slug' => $school_slug]) }}",
                    data: {

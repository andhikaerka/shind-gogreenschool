                    ...
                    <table class="table table-bordered table-striped table-hover">
                            ...
                            @if(auth()->check() && (auth()->user()->isAdmin || auth()->user()->isOperator))
                                <td>
                                    <div class="form-group">
                                        <select title="{{ trans('crud.assessment.fields.component_1') }}"
                        ...
                        <tr>
                            ...
                            @if(auth()->check() && (auth()->user()->isAdmin || auth()->user()->isOperator))
                                <td>
                                    <div class="form-group">
                                        <select title="{{ trans('crud.assessment.fields.component_2') }}"
                        ...
                        <tr>
                            ...
                            @if(auth()->check() && (auth()->user()->isAdmin || auth()->user()->isOperator))
                                <td>
                                    <div class="form-group">
                                        <select title="{{ trans('crud.assessment.fields.component_3') }}"
                        ...
                        <tr>
                            ...
                            @if(auth()->check() && (auth()->user()->isAdmin || auth()->user()->isOperator))
                                <td>
                                    <div class="form-group">
                                        <select title="{{ trans('crud.assessment.fields.component_4') }}"
                        ...
                        <tr>
                            ...
                            @if(auth()->check() && (auth()->user()->isAdmin || auth()->user()->isOperator))
                                <td>
                                    <div class="form-group">
                                        <select title="{{ trans('crud.assessment.fields.component_5') }}"
                        ...
                        <tr>
                            ...
                            @if(auth()->check() && (auth()->user()->isAdmin || auth()->user()->isOperator))
                                <td>
                                    <div class="form-group">
                                        <select title="{{ trans('crud.assessment.fields.component_6') }}"
                        ...
                        <tr>
                            ...
                            @if(auth()->check() && (auth()->user()->isAdmin || auth()->user()->isOperator))
                                <td>
                                    <div class="form-group">
                                        <select title="{{ trans('crud.assessment.fields.component_7') }}"
                                            class="form-control {{ $errors->has('component_6') ? 'is-invalid' : '' }}"
                                            name="component_7"
                        ...
                        <tr>
                            ...
                            @if(auth()->check() && (auth()->user()->isAdmin || auth()->user()->isOperator))
                                <td>
                                    <div class="form-group">
                                        <select title="{{ trans('crud.assessment.fields.component_8') }}"
                        ...
                        <tr>
                            ...
                            @if(auth()->check() && (auth()->user()->isAdmin || auth()->user()->isOperator))
                                <td>
                                    <div class="form-group">
                                        <select title="{{ trans('crud.assessment.fields.component_9') }}"
                        ...
                        <tr>
                            ...
                            @if(auth()->check() && (auth()->user()->isAdmin || auth()->user()->isOperator))
                                <td>
                                    <div class="form-group">
                                        <select title="{{ trans('crud.assessment.fields.component_10') }}"
                        ...
                        <tr>
                            ...
                            @if(auth()->check() && (auth()->user()->isAdmin || auth()->user()->isOperator))
                                <td>
                                    <div class="form-group">
                                        <select title="{{ trans('crud.assessment.fields.component_11') }}"
                        ...
                        <tr>
                            ...
                            @if(auth()->check() && (auth()->user()->isAdmin || auth()->user()->isOperator))
                                <td>
                                    <div class="form-group">
                                        <select title="{{ trans('crud.assessment.fields.component_12') }}"
                        ...
                        <tr>
                            ...
                            @if(auth()->check() && (auth()->user()->isAdmin || auth()->user()->isOperator))
                                <td>
                                    <div class="form-group">
                                        <select title="{{ trans('crud.assessment.fields.component_13') }}"
                        ...
                        <tr>
                            ...
                            @if(auth()->check() && (auth()->user()->isAdmin || auth()->user()->isOperator))
                                <td>
                                    <div class="form-group">
                                        <select title="{{ trans('crud.assessment.fields.component_14') }}"
                                            class="form-control {{ $errors->has('component_13') ? 'is-invalid' : '' }}"
                                            name="component_14"
                        ...
                        <tr>
                            ...
                            @if(auth()->check() && (auth()->user()->isAdmin || auth()->user()->isOperator))
                                <td>
                                    <div class="form-group">
                                        <select title="{{ trans('crud.assessment.fields.component_15') }}"
                        ...
                        <tr>
                            ...
                            @if(auth()->check() && (auth()->user()->isAdmin || auth()->user()->isOperator))
                                <td>
                                    <div class="form-group">
                                        <select title="{{ trans('crud.assessment.fields.component_16') }}"
                        ...
                        <tr>
                            ...
                            @if(auth()->check() && (auth()->user()->isAdmin || auth()->user()->isOperator))
                                <td>
                                    <div class="form-group">
                                        <select title="{{ trans('crud.assessment.fields.component_17') }}"
                        ...
                        <tr>
                            ...
                            @if(auth()->check() && (auth()->user()->isAdmin || auth()->user()->isOperator))
                                <td>
                                    <div class="form-group">
                                        <select title="{{ trans('crud.assessment.fields.component_18') }}"
                        ...
                        <tr>
                            ...
                            @if(auth()->check() && (auth()->user()->isAdmin || auth()->user()->isOperator))
                                <td>
                                    <div class="form-group">
                                        <select title="{{ trans('crud.assessment.fields.component_19') }}"
                        ...
                        <tr>
                            ...
                            @if(auth()->check() && (auth()->user()->isAdmin || auth()->user()->isOperator))
                                <td>
                                    <div class="form-group">
                                        <select title="{{ trans('crud.assessment.fields.component_20') }}"
                        ...
                        <tr>
                            ...
                            @if(auth()->check() && (auth()->user()->isAdmin || auth()->user()->isOperator))
                                <td>
                                    <div class="form-group">
                                        <select title="{{ trans('crud.assessment.fields.component_21') }}"
                                            class="form-control {{ $errors->has('component_20') ? 'is-invalid' : '' }}"
                                            name="component_21"
                        ...
                        <tr>
                            ...
                            @if(auth()->check() && (auth()->user()->isAdmin || auth()->user()->isOperator))
                                <td>
                                    <div class="form-group">
                                        <select title="{{ trans('crud.assessment.fields.component_22') }}"
                        ...
                        <tr>
                            ...
                            @if(auth()->check() && (auth()->user()->isAdmin || auth()->user()->isOperator))
                                <td>
                                    <div class="form-group">
                                        <select title="{{ trans('crud.assessment.fields.component_23') }}"
                        ...
                        <tr>
                            ...
                            @if(auth()->check() && (auth()->user()->isAdmin || auth()->user()->isOperator))
                                <td>
                                    <div class="form-group">
                                        <select title="{{ trans('crud.assessment.fields.component_24') }}"
                        ...
                        <tr>
                            ...
                            @if(auth()->check() && (auth()->user()->isAdmin || auth()->user()->isOperator))
                                <td>
                                    <div class="form-group">
                                        <select title="{{ trans('crud.assessment.fields.component_25') }}"
                        ...
                        <tr>
                            ...
                            @if(auth()->check() && (auth()->user()->isAdmin || auth()->user()->isOperator))
                                <td>
                                    <div class="form-group">
                                        <select title="{{ trans('crud.assessment.fields.component_26') }}"
                        ...
                        <tr>
                            ...
                            @if(auth()->check() && (auth()->user()->isAdmin || auth()->user()->isOperator))
                                <td>
                                    <div class="form-group">
                                        <select title="{{ trans('crud.assessment.fields.component_27') }}"
                        ...
                        <tr>
                            ...
                            @if(auth()->check() && (auth()->user()->isAdmin || auth()->user()->isOperator))
                                <td>
                                    <div class="form-group">
                                        <select title="{{ trans('crud.assessment.fields.component_28') }}"
                                            class="form-control {{ $errors->has('component_28') ? 'is-invalid' : '' }}"
                                            name="component_28"
                                            id="component_28" {{ app()->environment() == 'production' ? 'required' : '' }}>
                                            <option value=""
                                                    disabled {{ old('component_28', '') == '' ? 'selected' : '' }}>{{ trans('global.pleaseSelect') }}</option>
                                            @foreach(App\Assessment::COMPONENT_28_SELECT as $key => $label)
                                                <option
                                                    value="{{ $key }}" {{ old('component_28', ($assessment->component_28 ?? '')) == $key ? 'selected' : '' }}>
                                                    {{ $label }} (Nilai: {{ $key }})
                                                </option>
                                            @endforeach
                                        </select>
                                        @if($errors->has('component_28'))
                                            <span class="text-danger">{{ $errors->first('component_28') }}</span>
                                        @endif
                                    </div>
                                </td>
                            @else
                        ...
                        <tr>
                            ...
                            @if(auth()->check() && (auth()->user()->isAdmin || auth()->user()->isOperator))
                                <td>
                                    <div class="form-group">
                                        <select title="{{ trans('crud.assessment.fields.component_29') }}"
                                            class="form-control {{ $errors->has('component_29') ? 'is-invalid' : '' }}"
                                            name="component_29"
                                            id="component_29" {{ app()->environment() == 'production' ? 'required' : '' }}>
                                            <option value=""
                                                    disabled {{ old('component_29', '') == '' ? 'selected' : '' }}>{{ trans('global.pleaseSelect') }}</option>
                                            @foreach(App\Assessment::COMPONENT_29_SELECT as $key => $label)
                                                <option
                                                    value="{{ $key }}" {{ old('component_29', ($assessment->component_29 ?? '')) == $key ? 'selected' : '' }}>
                                                    {{ $label }} (Nilai: {{ $key }})
                                                </option>
                                            @endforeach
                                        </select>
                                        @if($errors->has('component_29'))
                                            <span class="text-danger">{{ $errors->first('component_29') }}</span>
                                        @endif
                                    </div>
                                </td>
                            @else

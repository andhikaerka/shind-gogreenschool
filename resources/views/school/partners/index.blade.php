...
@section('title')
    {{ trans('global.list') }} {{ trans('crud.partner.title_singular') }} - {{ trans('panel.site_title') }}
@endsection
            ...
            <div style="margin-bottom: 10px;" class="row">
                <div class="col-lg-12">
                    <a class="btn btn-success"
                       href="{{ route("school.partners.create", ['school_slug' => $school_slug, 'year' => request()->input('year')]) }}">
        ...
        <div class="card-body">
            <form action="" method="get" class="mb-3">
                <div class="row form-row">
                    ...
                    <div class="col mr-sm-2">
                        <div class="input-group">
                            <div class="input-group-prepend">
                                <span class="input-group-text bg-transparent border-0">Kondisi {{ trans('crud.partner.title') }}&nbsp;:</span>
                            </div>
                            <div class="input-group-append">
            ...
            <table class=" table table-bordered table-striped table-hover ajaxTable datatable datatable-Partner">
                ...
                <tr>
                    ...
                    <th>
                        {{ trans('crud.partner.fields.cp_phone') }}
                    </th>
                    <th>
                        {{ trans('crud.partner.fields.partner_category') }}
                    </th>
                    <th>
                        {{ trans('crud.partner.fields.partner_activity') }}
                    </th>
                    <th>
    ...
    <script>
        $(function () {
            ...
            let deleteButton = {
                ...
                url: "{{ route('school.partners.massDestroy', ['school_slug' => $school_slug]) }}",
            ...
            let dtOverrideGlobals = {
                ...
                aaSorting: [],
                ajax: {
                    url: "{{ route('school.partners.index', ['school_slug' => $school_slug]) }}",
                    data: {

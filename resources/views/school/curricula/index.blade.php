...
@section('title')
    {{ trans('global.list') }} {{ trans('crud.curriculum.title_singular') }} - {{ trans('panel.site_title') }}
@endsection
...
@section('content')
            ...
            <div style="margin-bottom: 10px;" class="row">
                <div class="col-lg-12">
                    <a class="btn btn-success"
                       href="{{ route("school.curricula.create", ['school_slug' => $school_slug, 'year' => request()->input('year')]) }}">
                        {{ trans('global.add') }} {{ trans('crud.curriculum.title_singular') }}
                    </a>
                </div>
            </div>
        @endcan
    ...
    <div class="card">
        <div class="card-header">
            {{ trans('global.list') }} {{ trans('crud.curriculum.title_singular') }}
        </div>
        ...
        <div class="card-body">
            <form action="" method="get" class="mb-3">
                <div class="row form-row">
                    ...
                    <div class="col mr-sm-2">
                        <div class="input-group">
                            <div class="input-group-prepend">
                                <span class="input-group-text bg-transparent border-0">Kondisi {{ trans('crud.curriculum.title') }}&nbsp;:</span>
                            </div>
                            <div class="input-group-append">
            ...
            <table class=" table table-bordered table-striped table-hover ajaxTable datatable datatable-Curriculum">
                ...
                <tr>
                    ...
                    <th>
                        {{ trans('crud.curriculum.fields.document') }}
                    </th>
                    <th>
                        {{ trans('global.action') }}
                    </th>
    ...
    <script>
        $(function () {
            ...
            let deleteButton = {
                ...
                url: "{{ route('school.curricula.massDestroy', ['school_slug' => $school_slug]) }}",
            ...
            let dtOverrideGlobals = {
                ...
                aaSorting: [],
                ajax: {
                    url: "{{ route('school.curricula.index', ['school_slug' => $school_slug]) }}",
                    data: {
                ...
                columns: [
                    ...
                    {data: 'calendars', name: 'calendars.name'},
            ...
            $('.datatable-Curriculum').DataTable(dtOverrideGlobals);

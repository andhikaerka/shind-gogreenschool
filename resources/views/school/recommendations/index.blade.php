...
@section('title')
    {{ trans('global.list') }} {{ trans('crud.recommendation.title_singular') }} - {{ trans('panel.site_title') }}
@endsection
...
@section('content')
            ...
            <div style="margin-bottom: 10px;" class="row">
                <div class="col-lg-12">
                    <a class="btn btn-success"
                       href="{{ route("school.recommendations.create", ['school_slug' => $school_slug]) }}">
    ...
    <div class="card">
        <div class="card-header">
            {{ trans('global.list') }} {{ trans('crud.recommendation.title_singular') }}
        </div>
        ...
        <div class="card-body">
            <form action="" method="get" class="mb-3">
                <div class="row form-row">
                    ...
                    <div class="col mr-sm-2">
                        <div class="input-group">
                            <div class="input-group-prepend">
                                <span class="input-group-text bg-transparent border-0">Kondisi {{ trans('crud.recommendation.title') }}&nbsp;:</span>
                            </div>
                            <div class="input-group-append">
            ...
            <table class=" table table-bordered table-striped table-hover ajaxTable datatable datatable-Recommendation">
                <thead>
                <tr>
                    <th style="width: 10px;">
    ...
    <script>
        $(function () {
            ...
            let deleteButton = {
                ...
                url: "{{ route('school.recommendations.massDestroy', ['school_slug' => $school_slug]) }}",
            ...
            let dtOverrideGlobals = {
                ...
                aaSorting: [],
                ajax: {
                    url: "{{ route('school.recommendations.index', ['school_slug' => $school_slug]) }}",
                    data: {
                ...
                columns: [
                    ...
                    {data: 'cadre_activity_work_program_name', name: 'cadre_activity.work_program.name'},
                    {data: 'cadre_activity_work_program_plan', name: 'cadre_activity.work_program.plan'},
            ...
            $('.datatable-Recommendation').DataTable(dtOverrideGlobals);

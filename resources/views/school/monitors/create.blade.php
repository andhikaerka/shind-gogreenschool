...
@section('content')
    ...
    <div class="card">
        <div class="card-header">
            {{ trans('global.create') }} {{ trans('crud.monitor.title_singular') }}
        </div>

        <div class="card-body">
            <form method="POST" action="{{ route("school.monitors.store", ['school_slug' => $school_slug]) }}"
                  id="formCreate">
                @csrf
                ...
                <div class="form-group">
                    ...
                    <select class="form-control select2 {{ $errors->has('work_group') ? 'is-invalid' : '' }}"
                            name="work_group_id" id="work_group_id" required="required" disabled="disabled">
                ...
                <div class="form-group">
                    <label class="required" for="team_statuses">{{ trans('crud.monitor.fields.team_statuses') }}</label>
                    ...
                    @endif
                    <span class="help-block">{{ trans('crud.monitor.fields.team_statuses_helper') }}</span>
                </div>

                <div class="form-group">
                    <label class="required"
                           for="document">{{ trans('crud.monitor.fields.document') }}</label>
...
@section('scripts')
    ...
    <script>
        ...
        $(function () {
            ...
            selectAspectId.val(('{{ old('aspect_id', '') }}')).trigger('change');
        });

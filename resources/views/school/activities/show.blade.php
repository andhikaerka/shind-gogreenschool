    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="form-group">
                <div class="form-group">
                    <a class="btn btn-default" href="{{ route('school.activities.index', ['school_slug' => $school_slug]) }}">
    ...
    {{--<div class="card">
        ...
        <div class="tab-content">
            <div class="tab-pane" role="tabpanel" id="activity_work_programs">
                @includeIf('school.activities.relationships.activityWorkPrograms', ['workPrograms' => $activity->activityWorkPrograms])
            </div>
        </div>
    </div>--}}

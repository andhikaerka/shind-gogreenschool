...
@section('title')
    {{ trans('global.list') }} {{ trans('crud.extracurricular.title_singular') }} - {{ trans('panel.site_title') }}
@endsection

@section('content')
    @if($school_slug == auth()->user()->school_slug)
        @can('extracurricular_create')
            <div style="margin-bottom: 10px;" class="row">
                <div class="col-lg-12">
                    <a class="btn btn-success"
                       href="{{ route("school.extracurriculars.create", ['school_slug' => $school_slug, 'year' => request()->input('year')]) }}">
                        {{ trans('global.add') }} {{ trans('crud.extracurricular.title_singular') }}
                    </a>
                </div>
            </div>
        @endcan
    ...
    <div class="card">
        <div class="card-header">
            {{ trans('global.list') }} {{ trans('crud.extracurricular.title_singular') }}
        </div>
        ...
        <div class="card-body">
            <form action="" method="get" class="mb-3">
                <div class="row form-row">
                    ...
                    <div class="col mr-sm-2">
                        <div class="input-group">
                            <div class="input-group-prepend">
                                <span class="input-group-text bg-transparent border-0">Kondisi {{ trans('crud.extracurricular.title') }}&nbsp;:</span>
                            </div>
                            <div class="input-group-append">
            ...
            <table class=" table table-bordered table-striped table-hover ajaxTable datatable datatable-Cadre">
                ...
                <tr>
                    ...
                    <th>
                        {{ trans('crud.extracurricular.fields.program') }}
                    </th>
                    <th>
                        {{ trans('crud.extracurricular.fields.tutor') }}
                    </th>
                    <th>
                        {{ trans('crud.extracurricular.fields.time') }}
                    </th>
                    <th>
                        {{ trans('crud.extracurricular.fields.participants') }}
                    </th>
                    <th>
                        {{ trans('crud.extracurricular.fields.activity') }}
                    </th>
                    <th>
                        {{ trans('crud.extracurricular.fields.target') }}
                    </th>
                    <th>
                        {{ trans('crud.extracurricular.fields.letter') }}
                    </th>
                    <th>
                        {{ trans('crud.extracurricular.fields.document') }}
                    </th>
                    <th>
                        {{ trans('global.action') }}
                    </th>
    ...
    <script>
        $(function () {
            ...
            let deleteButton = {
                ...
                url: "{{ route('school.extracurriculars.massDestroy', ['school_slug' => $school_slug]) }}",
            ...
            let dtOverrideGlobals = {
                ...
                aaSorting: [],
                ajax: {
                    url: "{{ route('school.extracurriculars.index', ['school_slug' => $school_slug]) }}",
                    data: {

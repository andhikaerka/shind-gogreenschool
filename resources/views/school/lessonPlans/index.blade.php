...
@section('title')
    {{ trans('global.list') }} {{ trans('crud.lessonPlan.title_singular') }} - {{ trans('panel.site_title') }}
@endsection
...
@section('content')
            ...
            <div style="margin-bottom: 10px;" class="row">
                <div class="col-lg-12">
                    <a class="btn btn-success"
                       href="{{ route("school.lesson-plans.create", ['school_slug' => $school_slug, 'year' => request()->input('year')]) }}">
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form action="" method="get" class="mb-3">
                <div class="row form-row">
                    ...
                    <div class="col mr-sm-2">
                        <div class="input-group">
                            <div class="input-group-prepend">
                                <span class="input-group-text bg-transparent border-0">Kondisi {{ trans('crud.lessonPlan.title') }}&nbsp;:</span>
                            </div>
                            <div class="input-group-append">
            ...
            <table class=" table table-bordered table-striped table-hover ajaxTable datatable datatable-LessonPlan">
                <thead>
                <tr>
                    <th style="width: 10px;">
                    ...
                    <th>
                        {{ trans('crud.lessonPlan.fields.environmental_issue_id') }}
                    </th>
                    <th>
    ...
    <script>
        $(function () {
            ...
            let deleteButton = {
                ...
                url: "{{ route('school.lesson-plans.massDestroy', ['school_slug' => $school_slug]) }}",
            ...
            let dtOverrideGlobals = {
                ...
                aaSorting: [],
                ajax: {
                    url: "{{ route('school.lesson-plans.index', ['school_slug' => $school_slug]) }}",
                    data: {
                ...
                columns: [
                    ...
                    {data: 'hook', name: 'hook'},
                    {data: 'environmental_issue', name: 'environmentalIssue.potency'},
                    {data: 'artwork', name: 'artwork'},
                    {data: 'hour', name: 'hour'},
                    {data: 'rpp', name: 'rpp', sortable: false, searchable: false},
                    {data: 'syllabus', name: 'syllabus', sortable: false, searchable: false},
            ...
            $('.datatable-LessonPlan').DataTable(dtOverrideGlobals);

...
@section('content')
    <div class="card">
        ...
        <div class="card-body">
            <form method="get" action="{{ route("admin.next-year-action-plans.index") }}">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('year') ? 'is-invalid' : '' }}" type="text"
                           name="year" id="year" value="{{ old('year', request()->get('year', (date('Y') + 1))) }}"
                           data-inputmask="'mask': ['9{4}'], 'placeholder': ''" data-mask required>
                    @if($errors->has('year'))
                ...
                <div>
                    <div class="row mb-3 font-weight-bold">
                        <div class="col">
                            ...
                            <div>TAHUN : {{ request()->get('year') }}</div>
                        </div>
                        <div class="col-4">
                            <div>&nbsp;</div>

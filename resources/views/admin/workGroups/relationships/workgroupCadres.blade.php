                ...
                <table class=" table table-bordered table-striped table-hover datatable datatable-workGroupCadres">
                    ...
                    @foreach($cadres as $key => $cadre)
                        <tr data-entry-id="{{ $cadre->id }}">
                            ...
                            <td>
                                @can('cadre_show')
                                    <a class="btn btn-xs btn-primary" href="{{ route('admin.cadres.show', $cadre->id) }}">
                                        {{ trans('global.view') }}
                                    </a>
                                @endcan

                                @can('cadre_edit')
                                    <a class="btn btn-xs btn-info" href="{{ route('admin.cadres.edit', $cadre->id) }}">
                                        {{ trans('global.edit') }}
                                    </a>
                                @endcan

                                @can('cadre_delete')
                                    <form action="{{ route('admin.cadres.destroy', $cadre->id) }}" method="POST" onsubmit="return confirm('{{ trans('global.areYouSure') }}');" style="display: inline-block;">

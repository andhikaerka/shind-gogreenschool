    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class=" table table-bordered table-striped table-hover datatable datatable-partnerStudies">
                    <thead>
                    <tr>
                        <th style="width: 10px;">
...
@section('scripts')
    ...
    <script>
        $(function () {
            ...
            $('.datatable-partnerStudies:not(.ajaxTable)').DataTable({buttons: dtButtons})

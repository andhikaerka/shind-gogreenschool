    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="form-group">
                <div class="form-group">
                    <a class="btn btn-default" href="{{ route('admin.quality-reports.index') }}">
    ...
    {{--<div class="card">
        ...
        <div class="tab-content">
            <div class="tab-pane" role="tabpanel" id="quality_report_studies">
                @includeIf('admin.qualityReports.relationships.qualityReportStudies', ['studies' => $qualityReport->qualityReportStudies])
            </div>
        </div>
    </div>--}}

<div class="m-3">
    @can('study_create')
        <div style="margin-bottom: 10px;" class="row">
            <div class="col-lg-12">
                <a class="btn btn-success" href="{{ route("admin.studies.create") }}">
    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class=" table table-bordered table-striped table-hover datatable datatable-qualityReportStudies">
                    <thead>
                    <tr>
                        <th style="width: 10px;">
                            ...
                            <td>
                                @can('study_show')
                                    <a class="btn btn-xs btn-primary"
                                       href="{{ route('admin.studies.show', $study->id) }}">
                                        {{ trans('global.view') }}
                                    </a>
                                @endcan

                                @can('study_edit')
                                    <a class="btn btn-xs btn-info" href="{{ route('admin.studies.edit', $study->id) }}">
                                        {{ trans('global.edit') }}
                                    </a>
                                @endcan
    ...
    <script>
        $(function () {
            ...
            let deleteButton = {
                ...
                url: "{{ route('admin.studies.massDestroy') }}",
            ...
            $('.datatable-qualityReportStudies:not(.ajaxTable)').DataTable({buttons: dtButtons})

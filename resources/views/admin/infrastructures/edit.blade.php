            ...
            <form method="POST" action="{{ route("admin.infrastructures.update", [$infrastructure->id]) }}"
                ...
                <div class="form-group">
                    ...
                    <select class="form-control select2 {{ $errors->has('school') ? 'is-invalid' : '' }}"
                        ...
                        @foreach($schools as $id => $school)
                            <option
                                value="{{ $id }}" {{ ($infrastructure->school ? $infrastructure->school->id : old('school_id')) == $id ? 'selected' : '' }}>{{ $school }}</option>
                        @endforeach
                    </select>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('name') ? 'is-invalid' : '' }}" type="text" maxlength="191"
                           name="name"
                           id="name" value="{{ old('name', $infrastructure->name) }}" required>
                    @if($errors->has('name'))
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control {{ $errors->has('function') ? 'is-invalid' : '' }}" name="function"
                              id="function" required>{{ old('function', $infrastructure->function) }}</textarea>

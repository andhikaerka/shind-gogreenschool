...
@section('content')
    ...
    <div class="card">
        <div class="card-header">
            {{ trans('global.create') }} {{ trans('crud.user.title_singular') }}
        </div>

        <div class="card-body">
            <form method="POST" action="{{ route("admin.users.store") }}" enctype="multipart/form-data" id="formCreate">
                @csrf
                ...
                <div class="form-group">
                    <div class="form-check {{ $errors->has('approved') ? 'is-invalid' : '' }}">
                        ...
                        <input class="form-check-input" type="checkbox" name="approved" id="approved"
                               value="1" {{ old('approved', 0) == 1 || old('approved') === null ? 'checked' : '' }}>

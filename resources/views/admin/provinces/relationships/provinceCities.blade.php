<div class="m-3">
        ...
        <div style="margin-bottom: 10px;" class="row">
            <div class="col-lg-12">
                <a class="btn btn-success" href="{{ route("admin.cities.create") }}">
                    {{ trans('global.add') }} {{ trans('crud.city.title_singular') }}
                </a>
            </div>
        </div>
    @endcan
    <div class="card">
        <div class="card-header">
            {{ trans('global.list') }} {{ trans('crud.city.title_singular') }}
        </div>
...
@section('scripts')
    ...
    <script>
        $(function () {
            ...
            $('.datatable-provinceCities:not(.ajaxTable)').DataTable({buttons: dtButtons})
